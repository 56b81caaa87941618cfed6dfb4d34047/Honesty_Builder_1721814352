...
*/
Vue.component("simple_footer_component_1721814353", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            Truthseeker - The Honesty Builder
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Truthseeker is committed to promoting honesty, integrity and ethical conduct. Our app helps cultivate habits of truthfulness through daily exercises, inspirational quotes, and a supportive community. Join us in building a more honest world.
                    </div>
                </div>
            </div>
        </footer> 
